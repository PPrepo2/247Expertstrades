!function(e, a) {
    ...
    function t(e, a, t) {
        ...
        return function() {
            ...
            return n = this,
            o = arguments,
            d <= 0 || d > a ? (r && (clearTimeout(r),
            r = null),
            s = c,
            i = e.apply(n, o),
            r || (n = o = null)) : r || t.trailing === !1 || (r = setTimeout(l, d)),
            i
        }
    }
    function n(e, a) {
        ...
        this.throttle ? this._strokeMoveUpdate = t(n.prototype._strokeUpdate, this.throttle) : this._strokeMoveUpdate = n.prototype._strokeUpdate,
        this.dotSize = i.dotSize || function() {
        ...
        this._handleMouseDown = function(e) {
            1 === e.which && (o._mouseButtonDown = !0,
            o._strokeBegin(e))
        }
        ,
        ...
        this._handleMouseUp = function(e) {
            1 === e.which && o._mouseButtonDown && (o._mouseButtonDown = !1,
            o._strokeEnd(e))
        }
        ,
    ...
    n.prototype._strokeUpdate = function(e) {
        var a = e.clientX
          ...
          , i = o.curve
          , r = o.widths;
        i && r && this._drawCurve(i, r.start, r.end),
    ...
    n.prototype._calculateCurveWidths = function(e) {
        ...
        return n.start = this._lastWidth,
        n.end = i,
    ...
    n.prototype._drawCurve = function(e, a, t) {
        ...
        for (var r = 0; r < i; r += 1) {
            var s = r / i
              ...
              , p = u * d
              , m = p * e.startPoint.x;
            m += 3 * u * s * e.control1.x,
            m += 3 * d * l * e.control2.x,
            m += c * e.endPoint.x;
            var f = p * e.startPoint.y;
            f += 3 * u * s * e.control1.y,
            f += 3 * d * l * e.control2.y,
            f += c * e.endPoint.y;
            var g = a + c * o;
    ...
    n.prototype._toSVG = function() {
        ...
        l.setAttributeNS(null, "width", t.width),
        l.setAttributeNS(null, "height", t.height),
        this._fromData(a, function(e, a, t) {
            ...
            if (!(isNaN(e.control1.x) || isNaN(e.control1.y) || isNaN(e.control2.x) || isNaN(e.control2.y))) {
                ...
                n.setAttribute("d", o),
                n.setAttribute("stroke-width", (2.25 * a.end).toFixed(3)),
            ...
            t.setAttribute("r", n),
            t.setAttribute("cx", a.x),
            t.setAttribute("cy", a.y),
...
function() {
    ...
    angular.module("app").config(["$mdThemingProvider", function(e) {
        e.theme("success-toast"),
        e.theme("error-toast"),
        e.theme("orange-toast"),
        e.theme("blue-toast"),
        e.theme("yellow-toast"),
        e.theme("fix success-toast"),
        e.theme("fix error-toast"),
        e.theme("fix orange-toast"),
        e.theme("fix blue-toast"),
        e.theme("fix yellow-toast"),
        e.theme("fix")
    }
    ])
}(window),
...
function() {
    ...
    var e = function() {
        ...
        return e.CardTypes = a,
        e.CheckCardNumber = function(t, n) {
            var o = "unknow"
              , i = !1
              , r = [16];
            return t = e.normalize(t),
            n ? $.each(n, function(e, n) {
                $.each(a, function(e, a) {
                    a.name == n && t.match(a.pattern) && (i = $.inArray(t.length, a.valid_length) != -1,
                    o = a.name,
                    r = a.valid_length)
                })
            }) : $.each(a, function(e, a) {
                t.match(a.pattern) && (i = $.inArray(t.length, a.valid_length) != -1,
                o = a.name,
                r = a.valid_length)
            }),
            {
    ...
    e.$inject = [],
    angular.module("app").factory("Ayden", e)
}(window),
function() {
    "use strict";
    var e = function(e, a, t, n, o, i, r, s, l, c, d, u) {
        ...
        p.payStackConfig = function() {
            ...
            return a && (p.paymant_stack = a.split(",")),
        ...
        ,
        p.paymant_stack = p.payStackConfig(),
        p.setStack = function(e) {
            p.paymant_stack = e
        }
        ,
        window.debugSetCascade = function(e) {
            window.is_casade_debug = !0,
            p.setStack(e)
        }
        ,
        p.current_calls = "",
                ...
                if (1 == e["return"]) {
                    ...
                    if (l) {
                        if ("successful" == l) {
                            ...
                            p.displayAlert("Card", '<div class="ui green inverted header">' + c + '</div><div class="em2">' + d + "</div>"),
                            p.HideAllToast(),
                            ...
                            p.displayAlert("Card", '<span class="ui red inverted header">' + m + "</span>"),
                            p.HideAllToast()
                        }
                        return !1
                    }
                    if ("transaction.succeeded" == e.data.event) {
                        ...
                        "alert" == p.alt.type && (p.displayAlert("Card", '<div class="ui green inverted header">' + c + '</div><div class="em2">' + d + "</div>"),
                        p.HideAllToast()),
                        a.$broadcast("user:update", {})
                    } else {
                        var m = Lang.get("orange.pay_fail")
                        ...
                        if (p.IsAllowCascade())
                            if ($.inArray(g, p.config.orange_no_cascade) != -1)
                                console.log(g, "allow PFS", !p.countryAllowPFS());
                            else {
                                var u = p.runCascade(n);
                                if (u)
                                    return !0
                            }
                        "alert" == p.alt.type && (m = Lang.get("cascade_card.failed"),
                        m = '<h4 class="phone-error">' + m + "</h4>",
                        p.displayAlert("Card", '<span class="ui red inverted header">' + m + "</span>"),
                        p.HideAllToast())
                    }
                } else
                    r || t(p.ListenCallbackOrange, p.IteratorTimeout)
            })
        }
        ,
            ...
            e.post("/api/card/listen/pfs", {
                ...
                if (1 == e["return"])
                    if ("0000" == e.data.R1) {
                        ...
                        "alert" == p.alt.type && (p.displayAlert("Card", '<div class="ui green inverted header">' + l + "</div><div>" + c + "</div>"),
                        p.HideAllToast()),
                        a.$broadcast("user:update", {})
                    } else {
                        var d = "";
                        if (d += _.isUndefined(e.data.R2) ? "" : e.data.R2,
                        d += _.isUndefined(e.data.R4) ? "" : "<br>" + e.data.R4,
                        p.IsAllowCascade()) {
                            var u = p.runCascade(n);
                            if (u)
                                return !0
                        }
                        "alert" == p.alt.type && (p.displayAlert("Card", '<span class="ui red inverted header">' + d + "</span>"),
                        p.HideAllToast())
                    }
                else
            ...
            e.post("/api/payconcept/listen", {
                ...
                if (1 == e["return"])
                    if ("APPROVED" == e.data.response) {
                        ...
                        "alert" == p.alt.type ? alertify.alert("Card", '<h4 class="phone-success p">' + s + '</h4><h4 class="phone-success p">' + l + "</h4>") : alertify.success(s),
                        p.updateUserDepositTmp()
                    } else {
                        ...
                        "alert" == p.alt.type ? (c = '<h4 class="phone-error">' + c,
                        c += "</h4>",
                        alertify.alert("Card", c)) : alertify.error(c, 0)
                    }
                else
                    i || t(p.ListenCallbackConcept, p.IteratorTimeout)
            })
        }
        ,
            ...
            e.post("/api/card/listen/skrill", {
                ...
                if (1 == e["return"]) {
                    ...
                    if ("2" == r) {
                        ...
                        p.displayAlert("Skrill", '<div class="ui green inverted header">' + s + "</div><div>" + l + "</div>"),
                        p.HideAllToast()
                    } else {
                        var c = "Error";
                    ...
                    o || t(p.ListenCallbackSkrill, p.IteratorTimeout)
            })
        }
        ,
            ...
            e.post("/api/fm/agni/listen", {
                ...
                if (e["return"] === !0) {
                    ...
                    if ("success" === s || "capturesuccess" === s) {
                        ...
                        if (d)
                            return !0;
                        var u = (p.getPath(e.data, "resultCode"),
                        p.getPath(e.data, "resultDescription"));
                        p.showErrorPayment(u)
                    }
                    p.HideAllToast()
                } else
                    i || t(p.ListenCallbackAgni, p.IteratorTimeout)
            })
        }
        ,
        ...
        p.ListenCardCallback = function(e, a, t) {
            ...
            e) {
            case "pfs":
                p.ListenToastDisplay(),
                p.ListenCallbackPFS();
                break;
            case "orange":
                p.ListenToastDisplay(),
                p.ListenCallbackOrange();
                break;
            case "skrill":
                p.ListenToastDisplay(),
                p.ListenCallbackSkrill();
                break;
            case "ezpay":
                p.ListenToastDisplay(),
                p.ListenCallbackEzpay();
                break;
            case "agni":
                p.ListenToastDisplay(),
                p.ListenCallbackAgni();
                break;
            default:
            ...
            e.post("/api/card/listen/ezpay", {
                ...
                if (e["return"] === !0) {
                    ...
                    if ("APPROVED" === s) {
                        ...
                        p.displayAlert("Card", '<div class="ui green inverted header">' + l + "</div><div>" + d + "</div>"),
                        p.HideAllToast()
                    } else {
                        ...
                        var f = p.getPath(e.data, "reason")
                          , g = f ? f : s;
                        g = Lang.get("cascade_card.failed"),
                        p.showErrorPayment(g),
                        p.HideAllToast()
                    }
                } else
                    i || t(p.ListenCallbackEzpay, p.IteratorTimeout)
            })
        }
        ,
        ...
        p.displayToast = function(e, a, t) {
            t || (t = 5e3),
            n.show(n.simple().textContent(a).theme(e + "-toast").position("bottom left").hideDelay(t))
        }
        ,
        ...
        p.WorkerPFS = function() {
            ...
            if (!p.WorkerTrigger(t)) {
                ...
                e.post("/api/card/fast/pfs", {
                    amount: r,
                    fixed: i,
                    bonus: o
                }).success(function(e, n, o, i) {
                    if (p.alt.uid = e.transaction_id,
                    p.alt.id = e.type,
                    p.alt.type = "alert",
                    p.alt.stop = !1,
                    "0000" != e.data.R1)
                        ...
                        p.secure3dRedirectPFS(e.data);
                    a.$broadcast("cascade:wait", !1)
                }).error(function(e, t, n, o) {
                    p.displayToastNew("error", "Response error, try again"),
                    a.$broadcast("cascade:wait", !1)
                })
            }
        }
                ...
                setTimeout(function() {
                    e.post("/api/card/fast/orange", {
                        ...
                        if ("success" == e.status) {
                            ...
                            p.displayAlert("Card", '<span class="ui red inverted header">' + l + "</span>")
                        }
                        a.$broadcast("cascade:wait", !1)
                    }).error(function(e, t, n, o) {
                        p.displayToastNew("error", "Response error, try again"),
        ...
        p.WorkerConcept = function(t) {
            ...
            if (!p.WorkerTrigger(o)) {
                var i = n.bonus
                  , r = n.fixed
                  , s = n.amount;
                t && (p.config.concept_redirect = !1),
                p.IsNeedWipeItems(),
                p.setItemCascade(o),
                a.$broadcast("cascade:wait", !0),
                e.post("/api/payconcept/pay", {
                    amount: s,
                    fixed: r,
                    bonus: i
                }).success(function(e, t, n, o) {
                    if (e.txid && p.initAlt(e.txid, "-1"),
                    "OK" == e.status)
                        "" != e.redirect.html ? location.href = e.redirect.html : p.ListenCallbackConcept();
                    else {
                        alertify.set("notifier", "position", "bottom-left");
                        var i = "Error";
                        e.error.msg && (i = "Your transaction was declined due to blacklisting, [customer requested] please contact merchant support." == e.error.msg || "003" == e.error.code ? "Your transaction was declined. Please contact merchant support." : e.error.msg),
                        alertify.alert("Card", '<h4 class="phone-error">' + i + "</h4>")
                    }
                    a.$broadcast("cascade:wait", !1)
                }).error(function(e, t, n, o) {
                    a.$broadcast("cascade:wait", !1),
        ...
        p.WorkerEzpay = function(e, a, t) {
            ...
            localStorage.setItem("ezpay_fixed", a),
            location.href = "/api/card/fast/ezpay?amount=" + e + "&fixed=" + a + "&bonus=" + t
        }
        ,
        ...
        p.WorkerEarth = function() {
            ...
            if (!p.WorkerTrigger(n)) {
                ...
                e.post("/api/card/fast/earth", {
                    ...
                    if (e.need_new_card)
                        return p.displayAlert("Card", '<div class="ui red inverted header">Old card is invalid. Please refill the card.</div><br>'),
                        void a.$broadcast("cascade:wait", !1);
        ...
        p.WorkerFraud = function() {
            ...
            if (!p.WorkerTrigger(n)) {
                ...
                p.setItemCascade(n),
                a.$broadcast("cascade:wait", !0),
                e.post("/api/fraud/card", {
                    amount: l,
                    fixed: s,
                    bonus: r
                }).success(function(e, t, r, s) {
                    return e.fail_limit ? (a.$broadcast("cascade:limit", !0),
                    void p.showErrorPayment(Lang.get("cards.limit"))) : e.day_limit ? (a.$broadcast("cascade:wait", !1),
                    void o.showConfirm("Information", "Dear client, due to safety reasons, your daily limit of 3 credit card transactions per day is exceeded. To continue depositing you are welcome to use alternative payment methods, such as bitcoin. Our support team may assist you in all questions regarding alternative funding methods.", function() {
                        o.CloseAll(),
                        o.showDynamic("/api/ag/modal_bitcoin", {
                            theme: "",
                            close: "bdw-close"
                        }, {
                            onHide: function() {
                    ...
                    })) : e.bad_card ? (a.$broadcast("cascade:wait", !1),
                    void p.showErrorPayment(Lang.get("cards.bad_card"))) : e.reason ? (a.$broadcast("cascade:wait", !1),
                    void p.showErrorPayment(e.message)) : (e.is_usa_card && p.cascadeCardType("usa_card"),
                    void p.runCascade(n))
        ...
        p.triggerBeforeAuto = function(e, a, t, n) {
            p.cascadeCardType(n),
            p.execDefaultTriggersAuto(e, a, t, n)
        }
        ,
        p.WorkerAuto = function(e, a, t, n) {
            ...
            p.setLastPayment(o),
            p.wipeItemCascade(),
            p.triggerBeforeAuto(e, a, t, n),
            User.get("cascade") && (p.paymant_stack = User.get("cascade").split(","));
        ...
        p.setItemCascade = function(e) {
            ...
            $.inArray(e, a) == -1 && (a.push(e),
            localStorage.setItem(t, a.join(",")))
        }
        ,
    ...
    e.$inject = ["$http", "$rootScope", "$timeout", "$mdToast", "ModalService", "Store", "$mdDialog", "$stateParams", "Entropay", "Zoom", "$state", "Ranger"],
...
function() {
    ...
    var e = function(e, a) {
        ...
        return t.tips = function(a, n) {
            t.showAmaran(Lang.get("tips.wait"), "2597c7", 5e3),
            setTimeout(function() {
                e({
                    method: "POST",
        ...
        ,
        a.$on("platform:chat:tips", t.tips),
        t
    };
    e.$inject = ["$http", "$rootScope"],
    angular.module("app").factory("Chat", e)
}(window),
function() {
    "use strict";
    var e = function(e, a, t, n, o) {
        ...
        ,
        i.fire = function(e) {
            "function" != typeof i.data[e].callback || i.data[e].callback_exe || (i.data[e].callback_exe = !0,
            i.data[e].callback()),
...
function() {
    ...
    var e = function(e, n, o, i, r, s, l, c) {
        ...
        ,
        d.entroPin = function() {
            User.get("entro_pin") && (d.appendModalWrapper(),
            l.show({
                clickOutsideToClose: !1,
                controller: t,
    ...
    e.$inject = ["$http", "$rootScope", "$timeout", "$mdToast", "ModalService", "Store", "$mdDialog", "$stateParams"],
    ...
    a.$inject = ["$scope", "$mdDialog", "$rootScope", "Store", "$http", "Cascade"],
    angular.module("app").controller("EntroStart", a);
    var t = function(e, a, t, n, o, i) {
        e.data = User.get("entro_pin") ? angular.fromJson(User.get("entro_pin")) : [],
        e.cvv = "",
        ...
        e.save = function() {
            return e.cvv.length < 3 ? void i.displayToastNew("error", "Please fill cvv!") : (o({
                ...
                e.amount && (User.set("isEntorpayCard", !0),
    ...
    t.$inject = ["$scope", "$mdDialog", "$rootScope", "Store", "$http", "Cascade"],
    ...
    var e = function(e, a, t) {
        return {
            ...
            link: function(e, n, o) {
                ...
                a.$on("file-up:drop", i),
                n.find('[type="file"]').on("change", function(t) {
                    var n = ($(this),
                    FileAPI.getFiles(t))
                            ...
                            FileAPI.upload({
                                ...
                                complete: function(t, n) {
                                    if (t) {
                                        ...
                                        !t && _.isObject(l.data._FILES.images) ? (s.name = l.data._FILES.images.name,
...
function() {
    ...
    var e = function(e, a) {
        ...
        t.platform_URL = "https://trade.binarymate.com",
        t.platform_URL_test = "",
        t.auth = {
            name: "SESSION",
        ...
        t.UpdateBalanceNew = function(e, t) {
            t.available && (User.set("available", t.available),
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s) {
        ...
        l.resetDefaults = function() {
            l.confirm = angular.copy(l.defaults.confirm),
            l.alert = angular.copy(l.defaults.alert),
            l.dynamic = angular.copy(l.defaults.dynamic)
        }
        ,
        ...
        l.showAlert = function(e, a, t, n, o) {
            l.resetDefaults(),
            t && (l.alert.ok = t),
            n && (l.alert = angular.extend(l.alert, n)),
            o && (l.semantic = angular.extend(l.semantic, o)),
            l.all.title = e,
            l.all.content = a,
            l.showModal(l.alert)
        }
        ...
        l.showConfirm = function(e, a, t, n, o, i) {
            l.resetDefaults(),
            t && (l.confirm.ok_trigger = t),
            n && (l.confirm.cancel_trigger = n),
            o && (l.confirm = angular.extend(l.confirm, o)),
            i && (l.semantic = angular.extend(l.semantic, i)),
            l.all.title = e,
            l.all.content = a,
            l.showModal(l.confirm)
        }
        ,
        l.refresh = function() {
        ...
        l.showDynamic = function(e, a, t) {
            l.resetDefaults(),
            l.dynamic.ag = e,
            a && (l.dynamic = angular.extend(l.dynamic, a)),
            t && (l.semantic = angular.extend(l.semantic, t)),
            l.showModal(l.dynamic)
        }
        ,
        l.displose = !1,
        l.showModal = function(e) {
            ...
            return l.getTemplate(!1, "/api/ag/modal").then(function(o) {
                ...
                var i = a.$new()
                  ...
                  , s = r(i);
                l.displose = i,
                i.$on("$includeContentLoaded", l.refresh);
                var c = $(s[0]).find(e["class"]);
                l.current = c,
                l.bindCancel(s),
                c.modal(l.semantic).modal("show"),
                t.resolve("hellow")
        ...
        l.displayToast = function(e, a, t) {
            t || (t = 5e3),
            s.show(s.simple().textContent(a).theme(e + "-toast").position("bottom left").hideDelay(t))
        }
        ,
        ...
        a.$on("modal:resize", l.refresh),
        l
    };
    e.$inject = ["$http", "$rootScope", "$timeout", "$compile", "$q", "$templateRequest", "$controller", "$mdToast"],
...
function() {
    ...
    var e = function(e, a) {
        ...
        t.cryptoCurrency = ["BTC", "LTC", "ETH", "DSH"],
        t.isCrypto = function(e) {
        ...
        if ((c || "US" === y || "CA" === y) && (n = 500),
        m && $.each(m, function(e, a) {
        ...
        User.get("md") && (n = parseInt(User.get("md"))),
        User.get("mdps") && (n = parseInt(User.get("mdps"))),
        t.getUserCurrency = function() {
        ...
        T = 60,
        n *= T),
        t.updateCurrency = function(e) {
            t.currency = t.isCrypto(e) ? "USD" : e,
            t.setCurrencyPrefix(e),
            a.$broadcast("ranger:currency:update", t)
        }
        ,
        t.setCurrencyPrefix = function(e) {
            e ? (t.prefix = t.mapPrefix[t.currency] ? t.mapPrefix[t.currency] : "",
            t.postfix = t.mapPostfix[t.currency] ? t.mapPostfix[t.currency] : "") : (t.prefix = "$",
            t.postfix = "")
        }
        ,
        ...
        t.slider = b,
        t.decimals = R,
        t.currency = t.isCrypto(k) ? "USD" : k,
        t.setCurrencyPrefix(k),
        t
    };
    e.$inject = ["$http", "$rootScope"],
...
function() {
    ...
    e.$inject = ["$http"],
    angular.module("app").directive("safari", e)
}(window),
function() {
    "use strict";
    var e = function(e, a) {
        ...
        return t.RegisterConversion = function(e) {
            ...
            $.getScript("https://www.googleadservices.com/pagead/conversion.js", e)
        }
        ,
...
function() {
        ...
        return {
            ...
            link: function(t, n, o, i) {
                ...
                i.$asyncValidators.ServerValidate = function(n, o) {
                    var i = n || o;
                    return c = !1,
                    "phone" == l ? "1" != t.user.phone_prefix ? a.resolve() : e.post(s, {
                        em: t.user.phone_prefix + "" + i
                    }).then(function(e) {
                        return c = 0 == e.data[l].error,
                        ...
                        return _.isUndefined(e.data[l]) || (c = 0 == e.data[l].error),
                        !!c || a.reject(e.data[l].message)
                    }, function() {
                        return a.reject("email does not exists")
                    })
    ...
    e.$inject = ["$http", "$q"],
    angular.module("app").directive("sv", e)
}(window),
function() {
    "use strict";
    var e = function(e, a, t, n, o, i, r, s, l) {
        var c = {};
        return c.timeout = 3e5,
        c.interval = {},
        c.alert = !1,
        c.getTemplate = function(e, a) {
            var t = s.defer();
        ...
        ,
        c.tick = function() {
            c.alert.counter > 0 ? (c.alert.counter -= 1,
            t(c.tick, 1e3),
            c.canvasInvalidate(c.alert.counter / .6)) : c.close()
        }
        ,
        c.canvasInvalidate = function(e) {
            ...
            s.addColorStop("0", "#2698c8"),
            s.addColorStop("1.0", "#126c92"),
            t.strokeStyle = s,
            t.arc(o, i, r, Math.PI / 180 * 270, Math.PI / 180 * (270 + n), !1),
            t.stroke()
        }
        ,
        ...
        ,
        c.run = function() {
            c.interval = n(c.loadData, c.timeout),
            t(c.loadData, 5e3)
        }
        ,
        c.stop = function() {
        ...
        ,
        c.run(),
        $(document).bind("signal.test", c.testSignal),
        $(document).bind("signal.real", c.loadData),
        c
    };
    e.$inject = ["$http", "$rootScope", "$timeout", "$interval", "$mdDialog", "Store", "$compile", "$q", "$templateRequest"],
        ...
        return {
            link: function(t, n, o, i) {
                ...
                var c = function(e, a) {
                  ...
                  , d = function(e, a) {
                    n[0].noUiSlider.destroy(),
                    s(a),
                    l()
                };
                t.$on("SliderSetValue", c),
                t.$on("ranger:currency:update", d)
            }
        }
    };
    ...
    var e = function(e, a, t, n, o, i, r, s) {
        ...
        l.fast = function(t, n, i, r) {
            ...
            e.post("/api/zoom", {
                ...
                if ("true" == e["return"]) {
                    if (!e.session) {
                        if (l.cascade.runCascade(l.cascade_name))
                            return;
                        return o.displayToastNew("error", "Response error, try again"),
                        void a.$broadcast("cascade:wait", !1)
                    }
                    l.session = e.session,
                    l.session_load = !0,
                    l.amount_tr = e.session.amount,
                    l.loadScripts()
                }
            }).error(function(e) {
                l.cascade.runCascade(l.cascade_name) || (o.displayToastNew("error", "Response error, try again"),
                a.$broadcast("cascade:wait", !1))
            })
        }
        ,
        ...
        l.loadScripts = function() {
            try {
                ...
                if (l.cascade.runCascade(l.cascade_name))
                    return;
                o.displayToastNew("error", "Response error, try again"),
                a.$broadcast("cascade:wait", !1)
            }
        }
        ,
        l.createFrom = function() {
            ...
            var e = $("#zoomform");
            e.append(l.addInput('data-ezpay-token-type="mode"', "MPI")),
            e.append(l.addInput('data-ezpay-token-type="card"', l.session.cnu)),
            e.append(l.addInput('data-ezpay-token-type="cvv"', l.session.cvv)),
            e.append(l.addInput('data-ezpay-token-type="expiry"', l.session.exp)),
            e.append(l.addInput('data-ezpay-token-type="amount-decimal"', parseFloat(l.amount_tr).toFixed(2))),
            e.append(l.addInput('data-ezpay-token-type="currency"', "USD")),
            l.getToken(e)
        }
        ,
        l.getToken = function(e) {
            EZPAY.API.getOrCreateCurtain(),
            EZPAY.API.tokenizeForm(e).done(function(e) {
                l.successToken(e)
            }).fail(l.failToken)
        }
        ,
        l.successToken = function(t) {
            e.post("/api/card/fast/zoom", {
                ...
                if ("true" == e["return"]) {
                    ...
                    if (console.log(r),
                    r)
                        return l.cascade.runCascade(l.cascade_name) ? void l.removeZoom() : (o.displayAlert("Card", '<span class="ui red inverted header">' + r + "</span>"),
                        l.removeZoom(),
                        void a.$broadcast("cascade:wait", !1));
                    ...
                    if (0 == s) {
                        ...
                        return o.displayAlert("Card", '<div class="ui green inverted header">' + m + "</div><div>" + f + "</div>"),
                        o.HideAllToast(),
                        a.$broadcast("user:update", {}),
                        a.$broadcast("cascade:wait", !1),
                        l.removeZoom(),
                    ...
                    if (l.cascade.runCascade(l.cascade_name))
                        return void l.removeZoom();
                    d || (d = "Card data not valid"),
                    l.removeZoom(),
                    o.displayAlert("Card", '<span class="ui red inverted header">' + d + "</span>")
                } else {
                    if (l.cascade.runCascade(l.cascade_name))
                        return void l.removeZoom();
                    var g = "Error";
                    ...
                    g = Lang.get("cascade_card.failed"),
                    o.displayAlert("Card", '<span class="ui red inverted header">' + g + "</span>")
                }
                a.$broadcast("cascade:wait", !1),
                l.removeZoom()
            }).error(function(e) {
                return l.cascade.runCascade(l.cascade_name) ? void l.removeZoom() : (o.displayToastNew("error", "Response error, try again"),
                void a.$broadcast("cascade:wait", !1))
            }),
            console.log(t)
        }
        ...
        l.failToken = function(t) {
            ...
            return l.cascade.runCascade(l.cascade_name) ? void l.removeZoom() : (l.removeZoom(),
            o.displayAlert("Card", '<span class="ui red inverted header">' + n + "</span>"),
            a.$broadcast("cascade:wait", !1),
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l, c, d, u) {
        ...
        ,
        e.init = function() {
            return "" === e.currency ? void c.displayToastAmaran("error", "Please chose currency!") : (e.loading = !0,
            void a({
                method: "POST",
                ...
                c.displayToastAmaran("success", "Account successfully added"),
                e.cancel()
            }).error(function(a) {
                c.displayToastAmaran("error", "Some errors, please try again."),
                e.loading = !1
            }))
        }
        ,
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$state", "Cascade", "Ayden", "$mdToast", "$mdDialog", "ModalService", "Store", "Ranger"],
        ...
        e.login = function() {
            ...
            var a = function(a, t, n, i) {
                if ("false" == a["return"])
                    return e.loading = !1,
                    e.error = a.message,
                    void $(".message.em").transition("shake");
              ...
              , i = function(a, t, n, o) {
                a ? e.error = a.message ? a.message : Lang.get("auth.server_error") : e.error = Lang.get("auth.server_error"),
...
function() {
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.address = "",
        e.firstLoad = !1,
        e.amount = e.$parent.slider ? e.$parent.slider.value : 0,
        e.processShape = function() {
            a({
                method: "POST",
                url: "/api/btc/shape"
            }).success(function(a) {
                ...
                e.b = a,
                e.status = "wt",
                e.address = a.data.address,
                $(".guid").html(a.data.guid),
                e.dec = a.data.ts,
                e.initCount()
            }).error(function(e) {})
        }
        ...
        "ex" !== e.status,
        e.$on("coundown:tick", e.cd_tick),
        i.$on("slideUiEnd", function(a, t) {
            e.amount = parseInt(t)
        }),
        i.$on("pay:tab:change", function(a, t) {
            e.firstLoad || (e.firstLoad = !0,
            e.processShape())
        })
    };
    e.$inject = ["$scope", "$http", "$timeout", "ModalService", "CountDown", "$rootScope"],
...
function() {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "FPlatform", "$state", "Cascade", "Ranger", "Store"],
...
function() {
    ...
    var e = function(e, a, t) {
        ...
        e.geo = Cc.get("GEO"),
        e.send = function() {
            return "" === e.phone ? void e.showAmaran(Lang.get("calls.error_phone")) : (e.loading = !0,
            void a({
                method: "POST",
                url: "/api/call",
                data: {
                ...
                e.loading = !1,
                e.showAmaran(Lang.get("calls.server_error"))
            }))
        }
        ,
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l, c, d, u) {
        ...
        e.amount = u.slider.bronze,
        e.$watch("cd", function() {
            if (!_.isUndefined(e.cd) && !_.isUndefined(e.cd.cty)) {
                if ("" == e.cd.cnu)
                    return void (e.cd = {});
                e.user = angular.copy(e.cd),
                d.card = angular.copy(e.cd)
            }
        }),
        e.addNew = function() {
            e.cd = void 0,
        ...
        e.checkCardLen = function() {
            return !!e.user.card_length_valid || (i.displayToastNew("error", "Valid card length " + e.user.card_length.join(" or ")),
            !1)
        }
        ,
        e.checkCardType = function() {
            var a = ["visa", "mastercard", "maestro"];
            return $.inArray(e.user.card_type, a) != -1 || (i.displayToastNew("error", "Invalid card type."),
            !1)
        }
        ,
        e.checkFormValid = function() {
            return !e.save_card_form.$invalid || (i.displayToastNew("error", "Please fill the required fields"),
            !1)
        }
        ,
        ...
        e.onlySave = function(t) {
            return !!(e.checkFormValid() && e.checkCardType() && e.checkCardLen()) && (e.setUserFL(),
            e.user.cnu = r.normalize(e.user.cnu),
            e.button_loading = !0,
            a.post("/api/card/save", e.user).success(function(a, t, n, o) {
                e.cd = e.user,
                e.button_loading = !1
        ...
        e.saveCard = function(t) {
            if (e.checkFormValid() && e.checkCardType() && e.checkCardLen() && e.checkMin()) {
                ...
                User.set("isEntorpayCard", !1),
                $.inArray(e.user.cnu.substr(0, 6), n) != -1 ? User.set("isEntorpayCard", !0) : User.set("isEntorpayCard", !1),
                a.post("/api/card/save", e.user).success(function(a, t, n, o) {
                    e.cd = e.user,
                    e.button_loading = !1,
                    e.whait = !0,
        ...
        e.setUserFL = function() {
            ...
            e.user.ln = e.tmpHolder.split(t)[1] ? e.tmpHolder.split(t).splice(1).join(t) : User.get("LastName")
        }
        ,
        e.scrollFo = function() {
            var e = $("#input-number");
        ...
        e.QuickAdd = function(e) {
            ...
            c.showConfirm(o, n, function() {
                ...
                c.displayToastAmaran("success", Lang.get("cards.form.whait_response")),
                i.WorkerAuto(0, 0, e, l, "fast"),
                c.CloseAll()
            }, !1, {
                ok: r,
                cancel: s,
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$templateCache", "Cascade", "Ayden", "$mdToast", "$mdDialog", "ModalService", "Store", "Ranger"],
...
function() {
    ...
    var e = function(e, a, t, n) {
        ...
        e.open = function() {
            ...
            e.is_first_load ? e.fixIframe() : (setTimeout(function() {
                e.loadChat()
            }, 1e3),
            e.is_first_load = !0);
            try {
        ...
        e.chatVerify = function() {
            e.chat_progress || (e.chat_progress = !0,
            a({
                method: "POST",
                url: "/api/triggers/chat"
            }).success(function(a) {
        ...
        ,
        n.$on("out:chat:promo", e.chatPromo),
        n.$on("chat:verification", e.chatVerify),
        e.chatOff = function() {
            ...
            if (e) {
                ...
                t.async = !0,
                t.src = "//code.jivosite.com/script/widget/" + a;
        ...
        ,
        e.chatOff() || (e.SubscribePlatformEvents(),
        e.isMobile(),
...
function() {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope"],
    angular.module("app").controller("ChatMain", e)
}(window),
function() {
    "use strict";
    var e = function(e, a, t) {
        ...
        e.send = function() {
            ...
            a({
                ...
                "false" == a["return"] ? (e.error = a.error,
                $(".message.em").transition("shake"),
                e.loading = !1) : (e.error = "",
                e.message = a.message,
                e.success = !0)
                ...
                e.loading = !1,
                e.error = a.message ? a.message : Lang.get("auth.server_error"),
                $(".message.em").transition("shake")
            })
        }
    };
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l, c) {
        ...
        ,
        e.tabs[Lang.get("sig")] && (e.tabs["default"] = e.tabs[Lang.get("sig")]),
        e.tabs[User.get("currency")] && (e.tabs["default"] = e.tabs[User.get("currency")]),
        e.isRisk = function() {
            return User.get("cardRisk") && "Full" !== User.get("verification")
        }
        ,
        e.isRiskPartner = function() {
            User.get("cardRisk") && "Full" !== User.get("verification") && (e.tabs["default"].current_path = "bitcoin",
            e.tabs["default"].card = "",
        ...
        if (e.OnUpdateSlide = function(a, t) {
            if (t[0]) {
                if (e.slider.value = parseFloat(t[0]),
                e.slider.value >= e.range.silver ? (e.slider.deposit = "gold",
                e.slider.procent = 2,
                e.slider.procent_value = 100) : e.slider.value >= e.range.bronze ? (e.slider.deposit = "silver",
                e.slider.procent = 1.5,
                e.slider.procent_value = 50) : (e.slider.deposit = "bronze",
        ...
        e.DepositBlur = function() {
            return "undefined" != typeof window.binary_debug ? void e.setMinToSlider(parseInt(e.slider.value)) : (e.slider.value < e.MinDeposit && (e.slider.value = e.MinDeposit),
        ...
        e.ChangeFix = function(a) {
            a ? (e.slider.is_bonus = !1,
            setTimeout(function() {
                $(".crypto-tabs").find(".item:visible:first").click()
            }, 100),
            e.getExchangeBalances()) : setTimeout(function() {
        ...
        e.PayReport = function(t) {
            ...
            "WebMoney" == t && (e.wm.wallet = e.wm.allow[e.wm.account],
            e.random[t] = "BMATE"),
            a.post("/api/report/" + t, {
                email: e.info.email,
        ...
        e.activatePromo = function() {
            ...
            a({
                ...
                "false" === a["return"] ? (e.promo_error = a.message ? a.message : Lang.get("auth.server_error"),
                e.promo_danger_show = !0,
                e.promo_success_show = !1) : (e.promo = "",
                e.promo_success_show = !0,
                e.promo_danger_show = !1),
                e.promo_loading = !1
            }).error(function(a) {
                e.promo_loading = !1,
                e.promo_error = a.message ? a.message : Lang.get("auth.server_error"),
                e.promo_loading = !1,
                e.promo_danger_show = !0,
                e.promo_success_show = !1
            })
        ...
        if (i.params.add && "payment_error" === i.params.add && c.displayAlert(Lang.get("payment.error.title"), '<span class="ui red inverted header">' + Lang.get("payment.error.message") + "</span>"),
        i.params.add && "payment_success" === i.params.add && c.displayAlert(Lang.get("payment.success.title"), '<span class="ui green inverted header">' + Lang.get("payment.success.message") + "</span>"),
        i.params.add && "payment_process" === i.params.add && c.displayAlert(Lang.get("payment.process.title"), '<span class="ui orange inverted header">' + Lang.get("payment.process.message") + "</span>"),
        ...
        e.payTabChange = function(a) {
            "card" === a && (e.showBitcoinPopup(),
            e.isRisk() && e.showPartnerRiskPopup())
        }
        ,
        ...
        e.isNeedShowBtcPopUp = function() {
            if (User.get("btc_deposit"))
                ...
                if (l.btc_show || User.get("btc_deposit") || e.getBtcDay() || Cc.get("SESSION.register_event"))
                    return;
                a({
                    method: "POST",
        ...
        window.honorTest = function() {
            e.once = !0,
            c.showDynamic("/api/ag/modal_honor", {
                theme: "honor wide",
                close: "bdw-close"
            }, {
                onHide: function() {
        ...
        e.fixedTab = function(a) {
            ...
            e.fixedCurrency = a,
            "BTC" === a ? $('.pay-tabs-content [data-tab="bitcoin"]').addClass("active") : "USD" === a || "EUR" === a ? $('.pay-tabs-content [data-tab="fiat"]').addClass("active") : ($('.pay-tabs-content [data-tab="litecoin"]').addClass("active"),
            $(".altcoins_drop").hide(),
            setTimeout(function() {
        ...
        e.initCurrentAccount = function() {
            ...
            if (a && _.isArray(a)) {
                if (1 !== a.length || User.get("current_accountId")) {
                    ...
                    e.current_balance = _.first(a),
                    e.setAccountId(d.accountId);
                e.current_balance.accountId ? ($(".amount-dropdown ." + e.current_balance.accountId).click(),
                e.initBalance = !0) : ($(".amount-dropdown .exchange-item").click(),
                e.ChangeFix(!0))
            }
        }
        ,
        e.changeCurrentAccount = function(a) {
            if (e.ChangeFix(!1),
            e.current_balance.accountId !== a.accountId) {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "FPlatform", "$state", "Cascade", "Ranger", "Store", "ModalService"],
...
function() {
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.send = function() {
            ...
            if (e.result = angular.copy(e.ResultDefault),
            !e.checkTimeImterval(n))
                return e.fieldToShake = !0,
                t(function() {
                    e.rep.date_to = "",
                    e.fieldToShake = !1
                }, 1e3),
                !1;
            n.date_from = n.date_from.split(".").reverse().join("-"),
            n.date_to = n.date_to.split(".").reverse().join("-");
            ...
            moment(n.date_from, c).isValid() && (o = 1e3 * moment.utc(n.date_from).unix()),
            moment(n.date_to, c).isValid() && (i = 1e3 * moment.utc(n.date_to).unix());
            var d = function(a) {
                e.result = angular.copy(e.ResultDefault),
                e.is_loading = !1
            };
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l) {
        ...
        e.limited = l.limited,
        e.offer = l.offer,
        s.is("limited") || s.run("limited", 180, function() {
            e.ignore()
        });
        var c = function(a, t) {
            "limited" == t.name && (e.days = t.days < 10 ? "0" + t.days : t.days,
          ...
          , d = function() {};
        e.accept = function() {
            n.$broadcast("limited-offer:accept"),
            i.CloseAll()
        }
        ,
        e.ignore = function() {
            n.$broadcast("limited-offer:ignore"),
            i.CloseAll()
        }
        ,
        e.ignoreAndTop = function() {
            n.$broadcast("limited-offer:ignoreandtop"),
            i.CloseAll()
        }
        ,
        e.$on("modal:cancel", d),
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$filter", "ModalService", "$state", "CountDown", "Store"],
            ...
            t.showConfirm(Lang.get("promo.enter"), e, function() {
                ...
                "" == e ? n(!0, Lang.get("promo.invalid")) : a({
                    ...
                    if ("false" == e["return"]) {
                        ...
                        t.CloseAll(),
                        t.displayToastAmaran("success", Lang.get("promo.activated"))
                }).error(function(e) {
...
function() {
    ...
    var e = function(a, t, n, o, i) {
        ...
        t.travis = "ru" == Lang.get("locale") ? r.ru : r.en,
        t.travis_error = "",
        t.current = o.current ? o.current : {},
        t.rss = o.rss ? o.rss : [],
        t.html = o.html ? o.html : {
            html: "Loading please wait..."
        },
        t.currentIndex = 0,
        t.weekend_enable = !1,
        t.checkIsWeekendEnable = function() {
        ...
        t.showWeekend = function() {
            i.semantic.closable = !0,
            i.showDynamic("/api/ag/tourney_weekend")
        }
        ,
        t.showCopy = function() {
            i.semantic.closable = !0,
            i.showDynamic("/api/ag/ladder", {
        ...
        t.loadRss = function(e, n) {
            ...
            a({
                ...
                t.rss = [],
                t.travis_error = "error load data.",
                t.showExoneDialog(n)
            })
        }
        ,
        ...
        t.copyNeedOpenGet = function() {
            setTimeout(function() {
                Cc.get("INPUT_LOCAL.copy_open") && User.get("userId") && !o.current && !o.copy_open_show && (t.showCopy(),
                o.copy_open_show = "yes")
            }, 401)
        }
        ,
        t.copyNeedOpenGet(),
        t.$on("news:calendar:show", t.showCalendar)
    };
    e.$inject = ["$http", "$scope", "$mdDialog", "Store", "ModalService"],
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l, c, d, u) {
        ...
        e.CheckCardCallback = function() {
            "listen" == r.params && (d.initAlt(r.add, r.add2),
            d.ListenCallbackPFS()),
            "listen-orange" == r.params && (d.initAlt(r.add, r.add2),
            d.ListenCallbackOrange()),
            "listen-union" == r.params && (e.alt.uid = r.add,
            e.alt.id = r.add2,
            e.ListenCardCallback4()),
            "listen-concept" == r.params && (d.initAlt(r.add, r.add2),
            ...
            a.post("/api/unionpay/listen", {
                ...
                if (1 == a["return"])
                    if ("00" == a.data.RespCode) {
                        ...
                        "alert" == e.alt.type ? (l = '<h4 class="phone-error">' + l,
                        l += "</h4>",
                        alertify.alert("Card", l)) : alertify.error(l, 0),
                        e.whait = !1
                    }
                else
                    o || n(e.ListenCardCallback4, e.CardIteratorTimeout)
            })
        }
        ,
        ...
        e.updateSlides = function() {
            e.slide.value >= e.zone.g("max") ? (e.slide.deposit = "gold",
            e.slide.procent = 100) : e.slide.value >= e.zone.g("20") ? (e.slide.deposit = "silver",
            e.slide.procent = 50) : (e.slide.deposit = "bronze",
            e.slide.procent = 20),
        ...
        e.PayReport = function(t) {
            function n() {
                for (var e = "", a = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", t = 0; t < 5; t++)
        ...
        e.CurrencyMinConverter = function() {
            var a = 50
              , t = (parseInt(User.get("First.amount")),
        ...
        e.InitPmSlideMove = function() {
            ...
            if ("RUB" == User.get("currency")) {
                if (parseInt(a) < e.accmin.RUB_CUR)
                    return
            } else if (parseInt(a) < e.accmin.EUR)
                return;
            var t = a
              , n = a
              , o = a
    ...
    e.$inject = ["$scope", "$http", "Spot", "$timeout", "$location", "$rootScope", "$routeParams", "$parse", "$compile", "CurrencyZone", "Cascade", "FPlatform"],
...
function() {
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.send = function() {
            ...
            if (e.$parent.slider.is_fixed && !_.isNaN(t) && _.isNumber(t) && t <= 0)
                return void i.displayToastAmaran("error", "Wrong amount!");
            if ("other" === e.alt)
                return void $(".other_form").submit();
            e.loading = !0;
            ...
            a({
                ...
                "true" === a["return"] ? location.href = "/api/" + e.alt + "/invoice/" + a.guid : i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
            }).error(function(a, t, n, o) {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "Ranger", "ModalService"],
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.send = function() {
            ...
            a({
                ...
                "true" === a["return"] ? location.href = "/api/ltc/invoice/" + a.guid : i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
            }).error(function(a, t, n, o) {
                i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.send = function() {
            if (e.is_vload)
                ...
                if (e.$parent.slider.is_fixed && !_.isNaN(l) && _.isNumber(l) && l <= 0)
                    return void i.displayToastAmaran("error", "Wrong amount!");
                e.loading = !0;
                var t = e.$parent.slider.is_bonus ? 1 : 0
                  , n = e.$parent.slider.is_fixed ? 1 : 0
            ...
            a({
                ...
                "true" == a["return"] ? location.href = "/api/btc/invoice/" + a.guid : i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
            }).error(function(a, t, n, o) {
                i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.send = function() {
            ...
            a({
                ...
                "true" == a["return"] ? location.href = "/api/eth/invoice/" + a.guid : i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
            }).error(function(a, t, n, o) {
                i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
...
function() {
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.send = function() {
            ...
            return e.$parent.slider.is_fixed && !_.isNaN(a) && _.isNumber(a) && a < o.minDeposit ? void i.displayToastAmaran("error", "Wrong amount! Min deposit " + o.minDeposit) : (e.$parent.slider.value = a,
            $(".pay-tabs-content .segment.active").removeClass("active"),
            $('.pay-tabs-content .segment[data-tab="' + e.alt + '"]').addClass("active"),
...
function() {
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.am = o.minDeposit,
        e.Neteller = function() {
            "" != e.pay.neteller.net_account && "" != e.pay.neteller.secure_id && "" != e.pay.neteller.amount && (e.neteller_form.$invalid || (e.neteller_loading = !0,
            a({
                method: "POST",
                url: "/api/neteller",
                data: e.pay.neteller
...
function() {
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.success = !1,
        e.Pay = function() {
            "" != e.pay.paypal.amount && (e.paypal_form.$invalid || (e.button_loading = !0,
            ...
            a({
                ...
                if ("success" == a.status)
                    a.data.redirect_url && (location.href = a.data.redirect_url);
                else {
                    var r = "Error";
                    a.message && (r = a.message),
                    o.displayAlert("Card", '<span class="ui red inverted header">' + r + "</span>")
                }
                e.server = a,
                e.button_loading = !1
            }).error(function(a, t, n, o) {
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.send = function() {
            ...
            a({
                ...
                "true" === a["return"] ? location.href = "/api/shape/invoice/" + a.guid : i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
            }).error(function(a, t, n, o) {
                i.displayToastAmaran("error", "some errors, try latter."),
                e.loading = !1
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.send = function() {
            ...
            a({
                ...
                "true" == a["return"] ? location.href = a.redirect : e.error = a.message,
                e.loading = !1
            }).error(function(a, t, n, o) {
                console.log("error"),
                e.loading = !1
...
function() {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "Ranger", "ModalService", "CountDown"],
...
function() {
    ...
    var e = function(e, a, t, n) {
        ...
        e.type_id = User.get("verification_type") ? User.get("verification_type") : "passport",
        e.send = function() {
            e.loading = !0,
            a({
                method: "POST",
                ...
                e.server = a,
                "true" == a["return"] ? User.set("phone", e.user.phone) : (e.error = a.error,
                e.loading = !1,
                $(".message.em").transition("shake")),
                e.loading = !1
            }).error(function(a, t, n, o) {
        ...
        $(".verification-new input[type=file]").on("change", function() {
            ...
            $.ajax({
                ...
                dataType: "JSON",
                success: function(a) {
                    "true" == a["return"] ? (e.info[t] = "up",
                    "passport" == t && (e.info.passport = "up"),
                    "card" == t && (e.info.card = "up",
                    e.loadCards()),
                    e.showAmaran("Upload successful")) : e.showAmaran("File type is not [ PNG, JPG, JPEG, PDF ]!", "#c0392b"),
                    e.ps_loading = !1,
                    e.cd_loading = !1,
                ...
                error: function(a) {
                    return 401 == a.status ? void (location.href = "/api/logout") : (e.showAmaran("Some errors try latter", "#c0392b"),
                    e.ps_loading = !1,
                    e.cd_loading = !1,
                    void e.setLoadingAssets(t, !1))
                }
            })
        }),
        ...
        e.initSignature = function() {
            ...
            e.sign_canvas = a.find("canvas").length > 0 && a.find("canvas")[0],
            e.sign_canvas && (e.resizeCanvas(),
...
function() {
    ...
    var e = function(e, a, t, n) {
            ...
            document.getElementById("save").addEventListener("click", function() {
                if (m) {
                    ...
                    t.onreadystatechange = function() {
                        4 == t.readyState && 200 == t.status && (t.responseText ? ($("#signature_box").hide(),
                        $("#document").hide(),
                        $("#link-to-pdf").text("Show document"),
                        e.info.sign = "1",
                        e.$digest()) : alert("Sorry, error."))
                    }
                    ,
        ...
        function d(e) {
            var a, t;
            return a = (e.cleintX || e.pageX) - p.offsetLeft,
        ...
        $(function() {
            ...
            $("input[name=passport],input[name=card]").on("change", function() {
                ...
                $.ajax({
                    ...
                    dataType: "JSON",
                    success: function(a) {
                        "true" == a.success ? ("passport" == n && (e.info.passport_new = "up"),
                        "card" == n && (e.info.card = "up"),
                        e.showAmaran("Upload successful"),
                        e.$digest()) : alert("File type is not [ PNG, JPG, JPEG, PDF ]!")
                    }
                }),
                !1
            })
...
function() {
    ...
    var e = function(e, a, t, n, o, i) {
        ...
        e.AddPromo = function() {
            ...
            a({
                ...
                e.server.AddPromo = t,
                "true" == t["return"] && a.post("/api/modal/modal-promo").success(function(a, t, n, o) {
                    var r = i(a.content)(e);
                    alertify.alert("", r[0])
                }),
                e.loading = !1
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "Spot", "$compile"],
...
function() {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$filter", "SEO", "ISO", "FPlatform"],
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.send = function() {
            ...
            var i = 1e3 * o.unix()
              ...
              , l = ""
              , c = ["MM/DD/YYYY", "MM-DD-YYYY", "YYYY-MM-DD"];
            moment(n.date_from, c).isValid() && (i = 1e3 * moment.utc(n.date_from).unix()),
            moment(n.date_to, c).isValid() && (r = 1e3 * moment.utc(n.date_to).unix());
            var d = function(a) {
                e.result = angular.copy(e.ResultDefault),
                e.is_loading = !1
            };
        ...
        e.loadMore = function() {
            ...
            moment(t.date_from, l).isValid() && (o = 1e3 * moment.utc(t.date_from).unix()),
            moment(t.date_to, l).isValid() && (i = 1e3 * moment.utc(t.date_to).unix());
            var c = function(a) {
                e.result = angular.copy(e.ResultDefault),
                e.is_loading = !1
            };
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l) {
        ...
        e.limited = l.limited,
        e.offer = l.offer,
        s.is("risk_free") || s.run("risk_free", 3600, function() {
            e.ignore()
        });
        var c = function(a, t) {
            "risk_free" == t.name && (e.days = t.days < 10 ? "0" + t.days : t.days,
            e.hours = t.hours < 10 ? "0" + t.hours : t.hours,
            e.minutes = t.minutes < 10 ? "0" + t.minutes : t.minutes,
            e.seconds = t.seconds < 10 ? "0" + t.seconds : t.seconds)
        }
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s, l) {
        ...
        l(function() {
            ...
            a !== e.update_last && (e.update_last = a,
            e.updateUser())
        }, 9e4),
        e.updateUser = function() {
            a({
                ...
                window.User = new OSG(a),
                e.checkIsNeedValidate(),
                n.$broadcast("user:update:success", window.User),
                e.needIQpopup()
            }).error(function(e) {
        ...
        e.Is5RiskFreePopup(),
        e.checkIsNeedValidate(),
        n.$on("user:update", e.updateUser),
        e.initGlobalsTest()
    };
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "FPlatform", "$state", "Signals", "ModalService", "$interval"],
...
function() {
    ...
    var e = function(e) {
        ...
        var t = function() {
          ...
          , n = function() {
            function e(e) {
                for (var a, t, n = e.length; n; a = Math.floor(Math.random() * n),
                t = e[--n],
                e[n] = e[a],
                e[a] = t)
                    ;
    ...
    e.$inject = ["$scope"],
    angular.module("app").controller("Runline", e)
}(window),
function() {
    "use strict";
    var e = function(e, a, t, n, o) {
        ...
        e.send = function() {
            if (e.secure.$valid) {
                ...
                var t = function(a) {
                  ...
                  , n = function(a) {
                    var t = "";
                    t = a.message && a.message ? a.message : Lang.get("messages.500"),
                    e.server = {
                        "return": "false",
                        message: t
                    },
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r) {
        ...
        e.applyFilter = function(a) {
            e.list.filter = a,
            e.list.filter_node = 0 == a ? e.list.node : _.where(e.list.node, {
                status_id: a
            }),
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$mdDialog", "Store", "ModalService"],
    angular.module("app").controller("Support", e);
    var a = function(e, a, t, n, o, i, r) {
        e.form = r.form ? r.form : {},
        e.ticket_loading = !1,
        e.ticket = {
            priority: "1",
            departments: "12",
        ...
        e.submitTicket = function() {
            ...
            a({
                ...
                e.ticket.content = "",
                e.ticket.subject = "",
                0 == t ? n.$broadcast("kayako:update-submit", {}) : n.$broadcast("kayako:update-list", {})
    ...
    a.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$compile", "$mdDialog", "Store"],
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.loadData = function(t, n) {
            a.post("/api/tourney/get", {
                ...
                e.filter_count = "weekly" == t.type ? 20 : 10)
            }).error(function(a) {
                e.showAmaran("Some errors...")
            })
        }
        ...
        e.showTab = function(a) {
            ...
            e.filter_count = "weekly" == e.current_list.type ? 20 : 10,
            e.current_list.id ? e.render = e.fetchReward(e.data[e.current_list.id]) : e.render = []
        }
        ,
        e.showAmaran = function(e, a) {
            var t = a ? "27ae60" : "e74c3c";
...
function() {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$filter", "ModalService", "$state"],
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r) {
        ...
        e.IsTradingBlock = function() {
            "Full" !== User.get("verification") && parseInt(User.get("depositsTotal")) > 0 && "USER_ACTIVE" !== User.get("status") && (e.is_block_platform = !0,
            "1" === User.get("doCard") ? e.is_block_card = !0 : e.is_block_verify = !0,
            $("#trading-platform").addClass("trading-blc"))
        }
        ,
        ...
        e.CloseChat = function() {
            e.chat.open = !1,
            $(".chat-platform-wrap,.ds-rework").addClass("closed"),
            $(".chat-platform-wrap .theme-wrap").css("width", "100%")
        }
        ,
        e.OpenChat = function() {
            $(".chat-platform-wrap,.ds-rework").removeClass("closed"),
            $(".chat-platform-wrap .theme-wrap").css("width", "")
        }
        ,
        e.MaxChat = function() {
            $(".min-max").addClass("max-active"),
            $(".chat-platform-wrap").removeClass("minimized").addClass("maximized"),
            $("#trading-chat").css("height", e.GetMaxChatHeight() + "px")
        }
        ,
        e.MinChat = function() {
            $(".min-max").removeClass("max-active"),
            $(".chat-platform-wrap").removeClass("maximized").addClass("minimized"),
            $("#trading-chat").css("height", "582px")
        }
        ,
        e.ChangeMax = function() {
            e.chat.max ? (e.chat.max = !e.chat.max,
            e.MinChat()) : (e.chat.max = !e.chat.max,
            e.MaxChat())
        }
        ,
        ...
        e.triggerLastHost = function() {
            var e = User.get("userId") + "host";
            localStorage.getItem(e) || setTimeout(function() {
                $(".video-chat-iframe").length > 0 && (a.post("/api/triggers/last_host"),
                localStorage.setItem(e, "yes"))
            }, 4e3)
        }
        ,
    ...
    e.$inject = ["$scope", "$http", "$timeout", "FPlatform", "$rootScope", "ModalService", "Chat"],
...
function() {
    ...
    var e = function(e, a, t, n, o) {
        ...
        e.copyText = function() {
            $(".copy-text").select(),
            document.execCommand("copy") ? n.displayToastAmaran("success", "Address copied to clipboard") : n.displayToastAmaran("error", "Unable to copy!")
        }
        ,
        e.cd_tick = function(a, t) {
            e.count = t
...
function() {
    ...
    var e = function(e, a, t, n, o, i, r, s) {
        ...
        e.btn_disabled = !1,
        e.is_max_try = !!l && parseInt(l) >= 5,
        e.tr_value = "",
        e.is_error = !1,
        e.error = "",
        e.parserVal = function(e, a, t) {
            var n = e
              , o = "[0-9]*";
            a > 0 ? o += "[,.]?[0-9]{0," + a + "}" : a < 0 && (o += "[,.]?[0-9]*"),
            o = t ? "^-?" + o : "^" + o,
            o += "$";
            var i = new RegExp(o);
            if (i.test(n))
            ...
            if (0 != a) {
                ...
                if (null != u) {
                    ...
                    p = p.replace(d, ""),
                    p = a > 0 ? p.substring(0, a) : p,
                    n = n.substring(0, u.index) + "." + p
                }
            }
            return n
        }
        ...
        e.sendData = function() {
            ...
            return "" == t ? (e.showAmaran('Please enter the correct amount without any extra characters, only numbers and signs "," or "."!'),
            void (e.btn_disabled = !1)) : void a({
                method: "POST",
                ...
                if ("false" == a["return"]) {
                    if (a.attemps <= 0)
                        return e.is_max_try = !0,
                        e.is_error = !1,
                        void (e.btn_disabled = !1);
                    e.tr_value = "",
                    e.is_error = !0,
                    e.error = Lang.get("validate_transcation.error").format(a.attemps)
                } else
                    User.set("tr_validate", "no"),
                    User.set("tr_success", "yes"),
                    s.go("home");
                e.btn_disabled = !1
            }).error(function(a, t, n, o) {
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$mdDialog", "Store", "$location", "$state"],
...
function() {
    ...
    var e = function(e, a, t, n, o, r) {
        ...
        e.loadPendings = function() {
            a.post("/api/us/pending", {}).success(function(a) {
                e.pending = a.hits,
                e.pending_loading = e.pending.length > 0
            }).error(function() {})
        }
        ,
        e.rejectPending = function(t) {
            r.showConfirm("Cancel", "Do you want to cancel this withdrawal?", function() {
                a.post("/api/us/reject", {
                    ...
                    r.displayToastAmaran("success", "Success"),
                    e.loadPendings()
                }).error(function() {
        ...
        e.fixedTab = function(a) {
            ...
            e.tab_current = a,
            "EUR" === t[a] || "USD" === t[a] ? (e.currency = t[a],
            e.changeMethodExchange()) : e.currency = "none"
        }
        ,
        e.changeMethodExchange = function() {
            console.log(e.wdm),
            e.CurrentProcessor = e.wdm
        }
        ,
        e.agree = function() {
            ...
            a.post("/api/withdrawal/final", {
                ...
                "true" == a["return"]) {
                    if (a.is_bonus) {
                        ...
                        r.displayAlert("Bonus", '<span class="ui green inverted header">' + t + "</span>")
                    } else
                        e.server["return"] = "true",
                        e.error = "";
                    e.loadPendings()
                } else
                    e.server["return"] = "",
                ...
                e.endLoad(!0),
                e.error = err.message ? err.message : Lang.get("auth.server_error")
            })
        }
        ,
        e.send = function() {
            var t = parseFloat(e.amount);
            if (isNaN(t) || t <= 0)
                return void r.displayToastNew("error", "Incorrect amount!");
            if (t > 0) {
                angular.copy(e.amount),
                angular.copy(e.CurrentProcessor);
                if (e.loading = !0,
                e.is_fixed)
                    return void e.finalSend();
                a.post("/api/withdrawal", {
                    ...
                    if ("true" == a["return"]) {
                        switch (e.current_turnover = a.current_turnover ? a.current_turnover.toFixed(0) : 0,
                        e.need_turnover = a.need_turnover ? a.need_turnover.toFixed(0) : 0,
                        a["case"]) {
                        case "one":
                            e.showCaseOne();
                            break;
        ...
        e.showCaseOne = function() {
            $(".deposit_and_withdraw2").length > 1 && $(".ui.dimmer .modal").remove(),
            $(".deposit_and_withdraw2:first").modal("show")
        }
        ,
        e.showCaseTwo = function() {
            $(".deposit_and_withdraw3").length > 1 && $(".ui.dimmer .modal").remove(),
            $(".deposit_and_withdraw3:first").modal("show")
        }
        ,
        e.showCaseThree = function() {
            $(".deposit_and_withdraw4").length > 1 && $(".ui.dimmer .modal").remove(),
            $(".deposit_and_withdraw4:first").modal("show")
        }
        ,
        ...
        e.currentBalanceAvaliable = function() {
            ...
            t && (e.current_amount = t.amount,
            e.current_currency = t.currency)
        }
        ,
        e.loadPendings(),
        e.initDropDown(),
    ...
    e.$inject = ["$scope", "$http", "$timeout", "$rootScope", "$mdDialog", "ModalService"],
...
!function(e, a, t) {
    ...
    function e(e) {
        ...
        var o, i = a(/(ipod|iphone|ipad)/i).toLowerCase(), s = /like android/i.test(e), l = !s && /android/i.test(e), c = /nexus\s*[0-6]\s*/i.test(e), d = !c && /nexus\s*[0-9]+/i.test(e), u = /CrOS/.test(e), p = /silk/i.test(e), m = /sailfish/i.test(e), f = /tizen/i.test(e), g = /(web|hpw)os/i.test(e), h = /windows phone/i.test(e), y = (/SamsungBrowser/i.test(e),
        !h && /windows/i.test(e)), v = !i && !p && /macintosh/i.test(e), w = !l && !m && !f && !g && /linux/i.test(e), b = t(/edg([ea]|ios)\/(\d+(\.\d+)?)/i), _ = a(/version\/(\d+(\.\d+)?)/i), T = /tablet/i.test(e) && !/tablet pc/i.test(e), $ = !T && /[^-]mobi/i.test(e), k = /xbox/i.test(e);
        /opera/i.test(e) ? o = {
            name: "Opera",
            opera: r,
        ...
        b ? (o.msedge = r,
        o.version = b) : (o.msie = r,
        o.version = a(/iemobile\/(\d+(\.\d+)?)/i))) : /msie|trident/i.test(e) ? o = {
        ...
        /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(e) && (o.firefoxos = r,
        o.osname = "Firefox OS")) : p ? o = {
            name: "Amazon Silk",
            silk: r,
        ...
        o.blink = r) : (o.name = o.name || "Webkit",
        o.webkit = r),
        !o.version && _ && (o.version = _)) : !o.opera && /gecko\//i.test(e) && (o.name = o.name || "Gecko",
        o.gecko = r,
        o.version = o.version || a(/gecko\/(\d+(\.\d+)?)/i)),
        o.windowsphone || !l && !o.silk ? !o.windowsphone && i ? (o[i] = r,
        o.ios = r,
        o.osname = "iOS") : v ? (o.mac = r,
        o.osname = "macOS") : k ? (o.xbox = r,
        o.osname = "Xbox") : y ? (o.windows = r,
        o.osname = "Windows") : w && (o.linux = r,
        o.osname = "Linux") : (o.android = r,
        o.osname = "Android");
        var R = "";
        o.windows ? R = n(a(/Windows ((NT|XP)( \d\d?.\d)?)/i)) : o.windowsphone ? R = a(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : o.mac ? (R = a(/Mac OS X (\d+([_\.\s]\d+)*)/i),
        R = R.replace(/[_\s]/g, ".")) : i ? (R = a(/os (\d+([_\s]\d+)*) like mac os x/i),
        R = R.replace(/[_\s]/g, ".")) : l ? R = a(/android[ \/-](\d+(\.\d+)*)/i) : o.webos ? R = a(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : o.blackberry ? R = a(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : o.bada ? R = a(/bada\/(\d+(\.\d+)*)/i) : o.tizen && (R = a(/tizen[\/\s](\d+(\.\d+)*)/i)),
        R && (o.osversion = R);
        ...
        o.msedge || o.msie && o.version >= 10 || o.yandexbrowser && o.version >= 15 || o.vivaldi && o.version >= 1 || o.chrome && o.version >= 20 || o.samsungBrowser && o.version >= 4 || o.firefox && o.version >= 20 || o.safari && o.version >= 6 || o.opera && o.version >= 10 || o.ios && o.osversion && o.osversion.split(".")[0] >= 6 || o.blackberry && o.version >= 10.1 || o.chromium && o.version >= 20 ? o.a = r : o.msie && o.version < 10 || o.chrome && o.version < 20 || o.firefox && o.version < 20 || o.safari && o.version < 6 || o.opera && o.version < 10 || o.ios && o.osversion && o.osversion.split(".")[0] < 6 || o.chromium && o.version < 20 ? o.c = r : o.x = r,
        o
    }
    function a(e) {
    ...
    function t(e, a) {
        ...
        if (Array.prototype.map)
            return Array.prototype.map.call(e, a);
    ...
    function o(a, t, o) {
        ...
        for (var l in a)
            if (a.hasOwnProperty(l) && i[l]) {
                if ("string" != typeof a[l])
                    throw new Error("Browser version in the minVersion map should be a string: " + l + ": " + String(a));
                return n([r, a[l]]) < 0
            }
        return t
    }
...
function() {
    "use strict";
    $(function() {
        Cc.get("INPUT.mobileapp") && (console.log("mobile"),
        $(Cc.get("INPUT.mobileapp")).hide())
    })
}(window),
function() {
    "use strict";
    $(function() {
        ...
        "LV" !== Cc.GEO && "PL" !== Cc.GEO && "MU" !== Cc.GEO || (a = "Algobit Ltd. (IBC No: 198028) - 309&310 Office, Albert Street Victoria, Mahe, Seychelles",
        t = "which operates on behalf of FGC"),
        a = "Algobit Ltd. (IBC No: 198028) - 309&310 Office, Albert Street Victoria, Mahe, Seychelles",
        t = "",
        $("[data-footer]").html(a),
        $("[data-footer1]").html(t),
