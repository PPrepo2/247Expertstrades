(function(g, h, A) {
    ...
    function tb(a, b, c, d, f) {
        ...
        function r(a, b, c, d, f, e) {
            for (var q; c && (q = n.getElementSize(c)) && (!q[0] || !q[1]); )
        ...
        function J(a) {
            var b = a[I];
            if (!b || 0 > b || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || S(a.form))
                return null;
                    ...
                    if (b[I])
                        ...
                        if (c) {
                            ...
                            for (var d = c.length, f = 0; f < d; f++)
                                /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(c[f].tagName) && !c[f][I] && N(c[f])
                        } else
                            N(b)
                    }
                else
        ...
        function Z(a) {
            ...
            if (!(10 > c)) {
                var d = B.getPos(a)
                  ...
                  , p = Xa[1] - d[1];
                f = f * f + p * p;
                0 >= f || 16 > f && 100 > c || 20 > c && 256 > f || (fb = b,
                Xa = d,
                H(a))
            }
        }
        function ca() {
            var a = n.getDocumentScroll()
              , b = m.nowTime();
            10 > b - gb || 10 > Math.abs(a[0] - Za[0]) && 10 > Math.abs(a[1] - Za[1]) || (gb = b,
            Za = a,
            G(Ca, [m.nowEventTime(), a]))
        }
        function W(a) {
            if (a = B.getTarget(a)) {
                var b = Math.random()
        ...
        function na(a, b, c) {
            a = B.getTarget(a);
            var d = X(a);
            d.ignore || !d.forceRecord && (d.isPrivate && f.get("isEU") || K(a)) || (N(a),
            G(A, [m.nowEventTime(), b, c, a, d.privateFlag]))
        }
        function oa(a) {
            var b = a.keyCode
              , c = ba(a);
        ...
        function fa(a) {
            $a && !ab && 0 !== a.which && (na(a, a.charCode || a.keyCode, ba(a)),
            ab = !0,
            e.setTimeout(function() {
                ab = !1
            }, 1, "vwl.keyPress"))
            ...
            if ("string" == typeof b) {
                ...
                if (c) {
                    ...
                    for (var d = 0; d < c.length && !a; )
                        a = X(c[d]).privateFlag || K(c[d], !0),
                        d++;
                    b != bb && (bb = b,
                    b = a ? e.map(function() {
                        return Fa.obfuscatedSymbol
                    }, b.split("")).join("") : b,
                    G(yb, [m.nowEventTime(), b]))
                }
            }
        }
        function Y() {
            ma || (ma = !0,
            bb && G(Da, [m.nowEventTime()]),
            e.setTimeout(function() {
                ma = !1
            }, 1, "wvl.copy"))
        }
                ...
                if (a[I])
                    ...
                    if (b) {
                        ...
                        for (var c = b.length, d = 0; d < c; d++)
                            /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][I] && N(b[d])
                    } else
                        N(a)
                }
        ...
        function R(a) {
            (a = B.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (N(a),
            G(y, [m.nowEventTime(), a]))
        }
        function aa(a) {
            if ((a = B.getTarget(a)) && !O(a) && !K(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var b = X(a)
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != h) {
                    ...
                    for (var c = 0; c < a.touches.length; c++)
                        G(r, [m.nowEventTime(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
                }
            }
        }
        function qa(a) {
            ...
            if (b) {
                ...
                c && (N(b),
                G(xb, [m.nowEventTime(), b, B.getPos(a), c]))
            }
        }
        function ib(a) {
        ...
        if (!e.isMetrikaPlayer()) {
            ...
            if ("onmousewheel"in h)
                l.on(h, "mousewheel", qa);
            else
                l.on(h, "wheel", qa);
            l.on(g, "beforeunload", ea);
            if (!Ab)
                l.on(g, "unload", ea);
            l.on(g, "resize", da);
            l.on(h, "keydown", oa);
            ...
            if (jb)
                l.on(h, "mouseleave", ib);
            h.attachEvent && !g.opera ? (l.on(h, "focusin", V),
            l.on(h, "focusout", T)) : (l.on(g, "focus", U),
            l.on(g, "blur", pa),
            l.on(h, "blur", pa));
            h.addEventListener ? (l.on(h, "scroll", W),
            l.on(h, "focus", v),
            l.on(h, "blur", R),
            l.on(h, "change", aa),
            l.on(h, "submit", L)) : h.attachEvent && (l.on(h, "focusin", v),
            l.on(h, "focusout", R),
            function() {
            ...
            "0:0" !== n.getDocumentScroll().join(":") && ca();
            da()
        }
        return {
            start: function() {
            ...
            stop: function() {
                ...
                l.un(g, "blur", pa);
                l.un(h, "blur", pa);
                h.removeEventListener ? (l.un(h, "scroll", W),
                l.un(h, "focus", v),
                l.un(h, "blur", R),
                l.un(h, "change", aa),
                l.un(h, "submit", L)) : h.detachEvent && (l.un(h, "focusin", v),
                l.un(h, "focusout", R),
                function() {
                    for (var a = h.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                        for (var c = a[b].getElementsByTagName("*"), d = 0; d < c.length; d++)
                            /^INPUT|SELECT|TEXTAREA$/.test(c[d].tagName) && l.un(c[d], "change", aa);
                        l.un(a[b], "submit", L)
                    }
                }());
                (function() {
                    for (var a = h.getElementsByTagName("form"), b = 0; b < a.length; b++)
                        a[b][ia] && (a[b].submit = a[b][ia])
                }
                )()
            },
            ...
            uploadPage: t(function(f) {
                ...
                if ("html" === f)
                    return f = new RegExp("\x3cscript [^\x3e]*?//" + D.host.replace(/\./g, "\\\\.") + "/watch/.*?\x3c/script\x3e","gi"),
                    x.sendContent(n.getDocumentHTML().replace(f, ""), q, d, Ga, Ha),
                    !0;
                e && (e.open("get", z().href, !0),
                e.onreadystatechange = t(function() {
                    if (4 === e.readyState) {
    ...
    function Db(a) {
        var b = [], c = a._lastPerformanceTiming, d = mb(), f;
        if (c) {
            var e = 0;
        ...
        , function(a, b) {
            ...
            b.hash = function(a, b) {
                ...
                var q = (a = a || "").length % 16
                  ...
                  , h = [0, b];
                b = [0, b];
                for (var l, x, u = [2277735313, 289559509], n = [1291169091, 658871167], m = 0; m < p; m += 16)
                    l = [255 & a.charCodeAt(m + 4) | (255 & a.charCodeAt(m + 5)) << 8 | (255 & a.charCodeAt(m + 6)) << 16 | (255 & a.charCodeAt(m + 7)) << 24, 255 & a.charCodeAt(m) | (255 & a.charCodeAt(m + 1)) << 8 | (255 & a.charCodeAt(m + 2)) << 16 | (255 & a.charCodeAt(m + 3)) << 24],
                    x = [255 & a.charCodeAt(m + 12) | (255 & a.charCodeAt(m + 13)) << 8 | (255 & a.charCodeAt(m + 14)) << 16 | (255 & a.charCodeAt(m + 15)) << 24, 255 & a.charCodeAt(m + 8) | (255 & a.charCodeAt(m + 9)) << 8 | (255 & a.charCodeAt(m + 10)) << 16 | (255 & a.charCodeAt(m + 11)) << 24],
                    l = f(l = c(l, u), 31),
                    h = d(h = f(h = g(h, c(l, n)), 27), b),
                    h = d(c(h, [0, 5]), [0, 1390208809]),
                    x = f(x = c(x, n), 33),
                    b = d(b = f(b = g(b, c(x, u)), 31), h),
                ...
                case 9:
                    x = c(x = g(x, [0, a.charCodeAt(m + 8)]), n),
                    b = g(b, c(f(x, 33), u));
                case 8:
    ...
    e.setTimeout = function(a, b, c) {
        return e.getNativeFunction("setTimeout")(t(a, c || "setTimeout"), b)
    }
    ;
    var l = C.inherit({
        ...
        on: function(a, b, c, d, f) {
            f = l._getOpts(f);
            b = b.split(",");
            var e = b.length, p = this._listeners, k;
            for (k = 0; k < e; k++) {
                var h = b[k];
                var m = t(function(a) {
        ...
        un: function(a, b, c, d, f) {
            f = l._getOpts(f);
            var g = this._listeners, p = g.length, k;
            for (k = 0; k < p; k++) {
                var h = g[k];
    ...
    var Ia = C.inherit({
        ...
        _initComponent: function() {
            ...
            this.storage && (a = this.storage.get(this.storageKey)) && a.data && a.meta && a.time && a.time + this.bufferExpireTime > +m.getMs() && this.onFlush.call(this.onFlushCtx || this, this.dataFromStorage(a.data), a.meta, a.pnum);
            this.clear()
        },
    ...
    X.stringify = function(a, b) {
        var c = [], d = b || {}, f = {}, g = e.keys(a).length, p, k;
        if (d.lastOrdering !== A)
    ...
    var Gb = Y.inherit({
        ...
        request: function(a, b, c, d) {
            ...
            c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), X.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    var la = {
        ...
        initPU: function(a, b) {
            var c = this;
            b.get("pu") !== A || this.checkVersion() || (this.globalConfig = b,
            b.setSafe("pu", null),
      ...
      , P = ya.inherit({
        ...
        _initComponent: function() {
            ...
            this.retry && (this._storage = new H)
        },
        send: function(a, b, c, d) {
    ...
    P.initCookie = function() {
        ...
        if (!b)
            b = d + "" + e.random(),
            a.create("uid", b, 525600),
            a.create("d", d, 525600);
        else if (!c || 15768E3 < d - parseInt(c))
            a.create("uid", b, 525600),
            a.create("d", d, 525600);
        P._userID = b
    }
    ...
    P.retransmit = function(a) {
        ...
        e.forEachKey(c, function(b, c) {
            ...
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 864E5 > f && 500 < f - c.time && 2 >= c.browserInfo.rqnl && (d = new P({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    K.encode = function(a, b) {
        var c = (K.abc + (b ? K.tailSafe : K.tail)).split(""), d = a.length, f = [], g = d - d % 3, p;
        for (p = 0; p < g; p += 3) {
    ...
    K.decode = function(a, b) {
        for (var c = K.abc + (b ? K.tailSafe : K.tail), d = 0, f = "", e, g, k, h, l; a.length % 4; )
            a += "\x3d";
        do {
    ...
    var ma = P.inherit({
        ...
        _hitExt: function(a, b) {
            ...
            if (!e.isMetrikaPlayer()) {
                ...
                -1 != z().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ? c("ut", cb) : "undefined" != typeof k.ut && c("ut", e.trim(k.ut, Ib));
                c("exp", a.experiments);
                ...
                f && (m = e.toJSON(f),
                this.trimParams && m.length > Jb ? g = !0 : m > D.maxBodyLength ? e.warning("Too big params") : c("site-info", m));
        ...
        _getTechInfo: function(a, b, c, d, f, h, p, k, l, u) {
            ...
            l._firstPaint || u || (l._firstPaint = Fb(),
            q("fp", l._firstPaint));
            if (k) {
    ...
    n.getElementXY = function(a) {
        var b;
        if (!a || !a.ownerDocument || "PARAM" == a.tagName || a == n.getBody() || a == h.documentElement)
            return [0, 0];
    ...
    n.getElementsByClassName = function(a, b) {
        ...
        for (c = 0; c < d.length; c++)
            n.classNameExists(d[c], a) && f.push(d[c]);
        return f
    }
    ;
    ...
    var Ja = ta.inherit({
      ...
      , db = ma.inherit({
            ...
            if (a) {
                a: {
                    if (a = e.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))
                        ...
                        -1 != e.arrayIndexOf(D.yandexWhiteListTld, a))
                            break a;
                    a = !1
                }
        ...
        sendHit: function(a) {
            ...
            b.ilt = K.encode(Pa.encode(e.trim(c, pb))));
      ...
      , Ka = C.inherit({
        ...
        hit: function(a, b) {
            ...
            f && f.params && f.time + 864E5 > m.getMs() ? (c.globalConfig.set("isEU", f.params.eu),
      ...
      , qb = C.inherit({
        ...
        _sync: function(a, b) {
            var c, d = 0, f = D.protocol + "//", e = a.length, g = this;
            if (0 < e) {
                b = b || function() {}
                ;
                var k = function() {
    ...
    var ha = {
      ...
      , Mb = {
        ...
        _enabled: function(a, b, c) {
            if (!(60 < m.getMinutes() - ha.getNum("ds")) || this._is() || e.isDev(this.globalConfig))
                return !1;
            ...
            for (f = a.length; h < f; h++) {
                if ((d = a[h]) && d.ymetrikaEvent) {
                    ...
                    if ("params" === l.type && l.data) {
                        l.sended || (l.sended = []);
                        if (l.counter)
                            this.counter && this.counter.params && this.counterId == l.counter && (this.onCookies(function(a) {
                                this.counter.params(a.data)
                            }, this, e.mixin({}, l)),
                            l.sended.push(this.counterId));
                        else
                            this.onCookies(function(a) {
                        ...
                        l.status == this.status.NEW && l.parent && this.frameConnector && this.frameConnector.checkFrame(g.parent) && g.parent !== g && (this.frameConnector.sendToParents({
                            type: "params",
                            data: l.data
                        }, function() {
                            l.status = this.status.OK
                        }, this),
                        l.status = this.status.PENDING)
                    }
                }
                if (d && d.ecommerce) {
                    var k = {};
    ...
    var Nb = {
        ...
        addAsyncItem: function(a, b, c, d, f) {
            ...
            g.flushAsync(!0)) : m.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = m.getMs(),
      ...
      , ba = C.inherit({
        ...
        handle: function() {
            ...
            if (!this.enabled && ("0" === h || r.isSafariWebView() || r.isAndroidWebView() || e.inArray(Ob, g.location.href.split("?")[0]) || !fa() || f.read("yandex_login") || this.disable))
                return f.read("yandex_login") ? this.trigger("GDPR-skip-login") : fa() ? "0" === h ? this.trigger("GDPR-skip") : r.isSafariWebView() || r.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"),
                this.realise(n, b);
    ...
    S.log = t(function() {
        ...
        g.console && console.log && this._check() && (S.enabled = !0,
      ...
      , Ta = C.inherit({
        ...
        checkAssessor: function() {
            ...
            e.forEachKey(b, function(c) {
                if ((new RegExp(c)).test(g.location.hash) || F.get(this.ASSESSOR_COOKIE + c))
                    F.set(this.ASSESSOR_COOKIE + c),
                    a.push(b[c])
            }, this);
            return a
        },
        ...
        _onMessage: function(a) {
            ...
            b && this._isAllowedOrigin(b) && (b = Z.parse(a.data)) && "appendremote" === b.action && this._isAllowedStatic(e.parseUrl(b.domain).host) && this._isAllowedLang(b.lang) && !this._executedMsgs[b.id] && (this._executedMsgs[b.id] = !0,
    ...
    }), J = z(), Ga = m.getTimezone(), Ha = m.getTimestamp(), Q = g.screen, Ib = 64, za = r.isIE() ? 512 : 2048, Jb = r.isIE() ? 512 : 2048, Ra = r.isIE() ? 100 : 400, pb = 100, cb = "noindex", sb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i, Ub = +new Date, eb, Ua, ua = function() {
        return "1521"
    }();
    ...
    g.Ya.Metrika = function(a, b, c, d) {
        ...
        return t(function() {
            function q(a) {
                ...
                if ((new RegExp("^https?://" + J.host + "/")).test(b))
                    return !1;
                var f = a.patterns;
                for (c = 0; c < f.length; c++) {
                ...
                if (a && "string" != typeof a && a.length)
                    for (d = 0; d < a.length; d++) {
                        ...
                        if ("#" == g) {
                            ...
                            for (g = n.getElementsByClassName(e),
                            e = 0; e < g.length; e++) {
                                c = !0;
                                var k = g[e]
                                  , l = f;
            ...
            function x(a, b) {
                ...
                d && (d = -1 < d.indexOf(";") ? e.safeDecodeURIComponent(d) : Pa.decode(K.decode(d.replace(/[-*_]/g, function(a) {
                    return {
                        "*": "+",
                        "-": "/",
                        _: "\x3d"
            ...
            function D() {
                            ...
                            callback: function(v, T) {
                                ...
                                if (!f.isDestructing()) {
                                    ...
                                    if (r) {
                                            ...
                                            if (R && R.length)
                                                for (aa = 0; aa < R.length; aa++) {
                                                    ...
                                                    if ("ref" == u.type)
                                                        ...
                                                        if (t && u && u.length && (t = !1,
                                                        ka = ka || C && C.campaign || E && E.campaign))
                                        ...
                                        R = n.read("mp2_track");
                                        r = r.substs && r.substs[R];
                                        R && r ? (n.create("mp2_substs", e.toJSON(r)),
                                        n = p(r),
                                        f.params("__ym", n ? "mp_trackid" : "mp_trackid_bad", R)) : k()
                                    } else
                                        k();
                ...
                0 != e.keys(y).length && (pa && pa.initUserLayer(),
                y.enableAll ? (Q(!0),
                U(!0),
                V()) : (y.clickmap && U(y.clickmap),
                y.trackLinks && Q(y.trackLinks),
                y.accurateTrackBounce && V(y.accurateTrackBounce)),
                ...
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !n.classNameExists(a, "ym-disable-tracklink")) {
                        ...
                        if (n.classNameExists(a, "ym-external-link"))
                            ...
                            Ja.set("pai", d.pai),
                            h && h !== c && Ja.set("il", e.trim(h, pb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (d.ut = cb,
                            O.sendClickLink({
                                url: c,
                                title: h,
                                modes: d
            ...
            function Da(a) {
                if (!1 === a)
                    ja && ("onhashchange"in g ? l.un(g, "hashchange", ta) : e.clearTimeout(Ka),
                    ja = !1);
                else if (a = ta,
                !ja) {
            ...
            var sa = "", y = {}, xa = "", ya = Qa.lastReferrer = J.href, za = 0, ra = !1, G;
            w.setSafe("counter", f);
            Oa && t(function() {
                throw Oa.error;
            }, "include." + Oa.scope)();
            ...
            if (!g["disableYaCounter" + a]) {
                    ...
                    init: function(a, b) {
                        ...
                        !(Math.random() >= a))) {
                            var c = {
                                ...
                                1417229093: 1,
                                138396985: 1
                            }, d = performance.getEntries(), f = {}, h = {}, k = {}, l = {}, m;
                ...
                f.replacePhones = u(function() {
                    ...
                    try {
                        (b = (new F({
                            counterId: a
                        })).read("mp2_substs")) && (c = Z.parse(b)) && p(c, !0)
                    } catch (R) {}
                    return f
                ...
                f.hit = u(function(b, c, d, g, h, k) {
                    b ? (e.isObject(c) && (d = c.referer,
                    g = c.params,
                    h = c.callback,
                    k = c.ctx,
                    c = c.title),
                    E = b,
                    S.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", g),
                    O.sendHit({
                        url: b,
                        title: c,
                        hasPrerender: ra,
                ...
                if (a) {
                    ...
                    if ("prerender" === h.webkitVisibilityState || "prerender" === h.visibilityState) {
                        ...
                        var hb = function() {
                            "prerender" !== h.webkitVisibilityState && "prerender" !== h.visibilityState && (l.un(h, "webkitvisibilitychange,visibilitychange", hb),
                            C(!0))
                        };
